...
max_lr = 6e-4
min_lr = max_lr * 0.1
warmup_steps = 715  # 375M tokens / 524288 tokens per step ≈ 715 steps
max_steps = 19073  # 10B tokens / 524288 tokens per step ≈ 19073 steps = ~1 epoch
def get_lr(it):
...
# import hellaswag for inline evaluation
